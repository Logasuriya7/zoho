public class Services extends TrainBooking {
    public static void Booktrain() {
        ...
        String seat = Seatallocate(bearthPreferance, bookingid, name);
...
//    }
    public static void DeleteBooking(int Cancelid) {
        ...
        if (racbearth != null) {
            ...
            if (cancledbreath.startsWith("U")) {
                Upper++;
            }
            if (cancledbreath.startsWith("M")) {
                Middle++;
            }
            if (cancledbreath.startsWith("L")) {
                Lower++;
            }
        }
    ...
    public static String Seatallocate(String bearthpreferance, int bookingid, String name) {
        if (bearthpreferance.equals("upper") && Upper > 0) {
            Upper--;
            return "U" + upperSeatNo++;
        } else if (name.equals("leksss") || name.equals("suriya")) {
            privateRoom--;
            return "private room";
    ...
    public void SeatAvailability() {
        ...
        System.out.println("PrivateRoom: " + privateRoom + "Only for leka ans suriya");
    }
}
